return {
	...
	dependencies = {
		-- Mason must be loaded here, before its dependents.
		-- `opts = {}` is the same as `require('mason').setup({})`
	...
	config = function()
		...
		-- Broadcast new features for the LSP, defined by nvim-cmp, luasnip, etc.
		...
		require("mason-tool-installer").setup({ ensure_installed = vim.ensure_installed })
